...
export const articles: Article[] = [
  {
    ...
    body: [
      ...
      { type: "ul", items: [
        ...
        "Prepare 8 behavioral stories and map each to leadership, teamwork, failure, conflict, initiative, and why this field.",
