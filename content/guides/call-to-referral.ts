...
export const guide: Guide = {
  ...
  date: "2026-09-21",
  author: "Tyler Ho",
  downloads: ["call-framework", "outreach-tracker"],
  ...
  body: [
    ...
    p("This guide covers the referral close, what to do with every kind of answer, how to stay warm for months, and how to track relationships so nothing slips. The call framework and referral close script are a free one-page download, and the outreach tracker is a free CSV."),
