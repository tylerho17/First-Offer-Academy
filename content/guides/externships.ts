...
export const guide: Guide = {
  ...
  date: "2026-09-21",
  author: "Tyler Ho",
  downloads: ["resume-template", "resume-rubric"],
  ...
  body: [
    ...
    p("This guide covers what an externship is, what counts and what doesn't, how to find one or create your own, how to do it well, and how to write it up. The resume template and rubric are free downloads."),
