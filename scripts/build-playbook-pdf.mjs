...
.cover .sub { font-family: "Source Serif 4"; font-weight: 600; font-size: 19pt; line-height: 1.25; margin-top: 18px; max-width: 5.6in; }
...
.cover .price-box strong { font-family: "Source Serif 4"; font-weight: 600; font-size: 14pt; display: block; margin-bottom: 4px; }
...
.toc .n { font-family: "Source Serif 4"; font-weight: 600; color: ${C.dusty}; font-size: 12pt; }
.toc a { color: ${C.navy}; text-decoration: none; font-family: "Source Serif 4"; font-weight: 600; font-size: 11pt; }
...
.big-quote { font-family: "Source Serif 4"; font-weight: 600; color: ${C.navy}; font-size: 22pt; line-height: 1.2; margin: 6px 0 16px; }
`;
